...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId ADD_NEW_SUBCLASS_S1; //rocknow-God
	...
	static
	{
		...
		ADD_NEW_SUBCLASS_S1 = new SystemMessageId(1269); //rocknow-God
		...
		if (Config.LANGUAGE == "en") //rocknow-Fix
		{
