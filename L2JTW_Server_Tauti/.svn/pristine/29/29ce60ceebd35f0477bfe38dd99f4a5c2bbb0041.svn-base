		...
		try
		{
			...
			while (rset.next())
			{
				...
				if (template1 != null)
				{
					...
					{
						_log.warning(MessageTable.Messages[2005].getExtra(1) + MessageTable.Messages[2005].getExtra(5) + rset.getInt("npc_templateid") + MessageTable.Messages[2005].getExtra(6));
						_log.warning(MessageTable.Messages[2005].getExtra(2) + MessageTable.Messages[2005].getExtra(5) + rset.getInt("npc_templateid") + MessageTable.Messages[2005].getExtra(6));
					}
					else if (template1.isType("L2GrandBoss")) //rocknow
					{
						// Don't spawn
						_log.warning(MessageTable.Messages[2006].getExtra(1) + " NPC ID: " + rset.getInt("npc_templateid") + " GrandBoss " + MessageTable.Messages[2006].getExtra(2)); //rocknow
					}
					else if (template1.isType("L2SiegeGuard")) //rocknow
					{
						// Don't spawn
						_log.warning(MessageTable.Messages[2006].getExtra(1) + " NPC ID: " + rset.getInt("npc_templateid") + " SiegeGuard " + MessageTable.Messages[2006].getExtra(2)); //rocknow
					}
					else if (template1.isType("L2RaidBoss"))
					{
						// Don't spawn raidboss
						_log.warning(MessageTable.Messages[2006].getExtra(1) + " NPC ID: " + rset.getInt("npc_templateid") + " RaidBoss " + MessageTable.Messages[2006].getExtra(2)); //rocknow
					}
					else if (!Config.ALLOW_CLASS_MASTERS && template1.isType("L2ClassMaster"))
					{
						// Dont' spawn class masters
						_log.warning(MessageTable.Messages[2006].getExtra(1) + " NPC ID: " + rset.getInt("npc_templateid") + " ClassMaster " + MessageTable.Messages[2006].getExtra(2)); //rocknow
					}
					else
					{
			...
			try
			{
				...
				while (rset.next())
				{
					...
					if (template1 != null)
					{
						if (template1.getAIDataStatic().getAggroRange() == -1) //rocknow-Test Only
						{
							_log.warning(MessageTable.Messages[2005].getExtra(3) + MessageTable.Messages[2005].getExtra(5) + rset.getInt("npc_templateid") + MessageTable.Messages[2005].getExtra(6));
							_log.warning(MessageTable.Messages[2005].getExtra(4) + MessageTable.Messages[2005].getExtra(5) + rset.getInt("npc_templateid") + MessageTable.Messages[2005].getExtra(6));
						}
						else if (template1.isType("L2GrandBoss")) //rocknow
						{
							// Don't spawn
