...
public final class Config
{
	...
	public static final String PCBANG_CONFIG_FILE = "./config/pccafe.properties"; //l2jtw add
	...
	/** Max BOOKMARKSLOT  */ //rocknow-God
	public static int MAX_BOOKMARKSLOT;  //l2jtw add
	/** Custom Settings */ 
	...
	public static int Interval_Of_Sailren_Spawn; //rocknow
	public static int Random_Of_Sailren_Spawn; //rocknow
	...
	public static boolean PREDEFINE_ITEMS_LOAD; //l2jtw add
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try (InputStream is = new FileInputStream(chars))
			{
				...
				STARTING_VITALITY_POINTS = Integer.parseInt(Character.getProperty("StartingVitalityPoints", "140000")); //rocknow-God
			...
			try (InputStream is = new FileInputStream(l2jmods))
			{
				...
				PREDEFINE_ITEMS_LOAD = Boolean.parseBoolean(L2JModSettings.getProperty("PredefineItemsLoad", "True")); //l2jtw add
			}
			catch (Exception e)
			{
				_log.warning("Config: " + e.getMessage());
			...
			try (InputStream is = new FileInputStream(custom))
			{
				...
				MAX_BOOKMARKSLOT = Integer.parseInt(customSettings.getProperty("MaxBookMarkSlot", "9")); //l2jtw add
				MAX_BOOKMARKSLOT = (MAX_BOOKMARKSLOT / 3) * 3; //l2jtw add
