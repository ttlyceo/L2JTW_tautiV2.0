...
public final class SetupGauge extends L2GameServerPacket
{
	...
	public static final int BLUE_DUAL = 2; //rocknow-God-Awaking
	public static final int BLUE = 2; //rocknow-God-Awaking
	public static final int BLUE_MINI = 2; //rocknow-God-Awaking
	public static final int GREEN_MINI = 3; //rocknow-God-Awaking
	public static final int RED_MINI = 1; //rocknow-God-Awaking
