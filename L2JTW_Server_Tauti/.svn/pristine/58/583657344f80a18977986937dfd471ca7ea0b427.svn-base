...
public abstract class L2Summon extends L2Playable
{
	...
	{
		owner.sendPacket(new PetInfo(this, 2)); //l2jtw add
	...
	public void onTeleported()
	{
		...
		sendPacket(new ExTeleportToLocation(this, getPosition().getX(), getPosition().getY(), getPosition().getZ(), getPosition().getHeading()));//488 Test
	}
