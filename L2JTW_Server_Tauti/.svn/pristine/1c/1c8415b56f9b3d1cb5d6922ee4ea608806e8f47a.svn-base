...
public class CharStat
{
	...
	public float getMovementSpeedMultiplier()
	{
		 ...
		 */
		return getRunSpeed() / (float) (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseRunSpd();
		// l2jtw end
	}
	...
	public int getRunSpeed()
	{
		 ...
		 */
		double baseRunSpd = (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseRunSpd();
		// l2jtw end
	...
	public int getWalkSpeed()
	{
		 ...
		 */
		double baseWalkSpd = (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseWalkSpd();
		// l2jtw end
