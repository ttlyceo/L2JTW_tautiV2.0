...
import com.l2jserver.gameserver.network.serverpackets.FriendList; //rocknow-God
	...
	protected void runImpl()
	{
		...
		try
		{
			...
			*/
			...
			activeChar.sendPacket(new FriendList(activeChar)); //rocknow-God
			...
			if (player != null)
			{
				...
				player.sendPacket(new FriendList(player)); //rocknow-God
			}
		}
		catch (Exception e)
		{
